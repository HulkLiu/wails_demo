...
const utils_1 = require("../../upload/src/utils");
...
exports.default = (0, vue_1.defineComponent)({
    ...
    setup(props) {
        ...
        function handleDownloadClick() {
            ...
            if (src) {
                (0, utils_1.download)(src, undefined);
            }
        }
                        ...
                        this.showToolbar ? ((0, vue_1.h)(vue_1.Transition, { name: "fade-in-transition", appear: this.appear }, {
                            default: () => {
                                ...
                                return ((0, vue_1.h)("div", { class: `${clsPrefix}-image-preview-toolbar` },
                                    ...
                                    withTooltip((0, vue_1.h)(_internal_1.NBaseIcon, { clsPrefix: clsPrefix, onClick: this.resizeToOrignalImageSize }, {
                                        default: () => {
                                    ...
                                    withTooltip((0, vue_1.h)(_internal_1.NBaseIcon, { clsPrefix: clsPrefix, onClick: this.handleDownloadClick }, { default: () => icons_2.downloadIcon }), 'tipDownload'),
