...
exports.default = (0, vue_1.defineComponent)({
    ...
    render() {
        ...
        const imgNode = (0, vue_1.h)('img', Object.assign(Object.assign({}, imgProps), { ref: 'imageRef', width: this.width || imgProps.width, height: this.height || imgProps.height, src: this.showError
                ? this.fallbackSrc
            ...
            loading: is_native_lazy_load_1.isImageSupportNativeLazy && lazy && !this.intersectionObserverOptions
                ? 'lazy'
                : 'eager', style: [
                imgProps.style || '',
