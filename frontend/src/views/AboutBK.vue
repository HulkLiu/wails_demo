<template #title>
  ...
  <el-form :model="form" label-width="-10px">
    ...
    <el-form-item >
      <el-input class="DocSearch-Input" placeholder="Search" v-model="form.query" @keyup.enter="begin"/>
...
<script>
import { ExportVideoList, VideoList, VideoManage } from '../../wailsjs/go/internal/App'
import { SearchKey } from "../../wailsjs/go/internal/App.js";
import { OpenFolder } from "../../wailsjs/go/internal/App.js";
...
export default defineComponent({
  setup() {
    ...
    const searchVideoList = async () => {
      ...
      const res = await SearchKey(form);
      if (res.code !== 200) {
        ElNotification({
          title: res.msg,
          type: "error",
